...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Liza Mwol' : process.env.ALL_CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://raw.githubusercontent.com/ItIsHM/LizaMwolByHM/master/image/logo.jpg' : process.env.GAN_IMAGE,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://c.tenor.com/QNtFLycfQiAAAAPo/pika-Liza Mwol.mp4' : process.env.GIF_WEL,
    ...
    SUDO: process.env.SUDO === undefined ? '916235199845,0' : process.env.SUDO,
    DEBUG: DEBUG,
